...
private static double[] CalculatePrayerTime(int year, int month, int day, double longitude,
        ...
        /*
        private static double longitude = GPS.Longitude;
        private static double latitude = GPS.Latitude;
        private static int fajrTwilight = -18;
        private static double ishaTwilight=-17.1;
